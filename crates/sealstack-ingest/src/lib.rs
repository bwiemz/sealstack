...
//! [`Ingestor`](sealstack_engine::ingest::Ingestor) to persist the row and upsert
...
//! ```text
//!                                      ┌──────────────────────┐
//!      sealstack connector sync <name>  ───▶ │   IngestRuntime      │
//!                                      │                      │
//!   sealstack connector start-background ──▶ │  sync_once / start   │
//!                                      │  cancellation        │
//!                                      │                      │
//!                                      └──────────┬───────────┘
//!                                                 │
...
//!
//! Incremental sync via the `sealstack_ingest_state` table is stubbed out and lands
//! in v0.2.
