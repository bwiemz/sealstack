...
//! [`Ingestor`](cfg_engine::ingest::Ingestor) to persist the row and upsert
...
//! ```text
//!                                      ┌──────────────────────┐
//!      cfg connector sync <name>  ───▶ │   IngestRuntime      │
//!                                      │                      │
//!   cfg connector start-background ──▶ │  sync_once / start   │
//!                                      │  cancellation        │
//!                                      │                      │
//!                                      └──────────┬───────────┘
//!                                                 │
...
//!
//! Incremental sync via the `cfg_ingest_state` table is stubbed out and lands
//! in v0.2.
