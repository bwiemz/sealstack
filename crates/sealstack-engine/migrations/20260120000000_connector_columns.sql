-- Extend sealstack_connectors with the columns needed to reconstruct a
...
ALTER TABLE sealstack_connectors
...
CREATE INDEX IF NOT EXISTS sealstack_connectors_kind_idx
    ON sealstack_connectors (kind)
    WHERE kind <> '';
