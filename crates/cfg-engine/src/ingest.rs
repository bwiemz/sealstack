//! Ingestion pipeline.
//!
//! Ingestion is the process of taking a [`cfg_connector_sdk::Resource`] from a
...
//!
//! The ingestion pipeline is called from `cfg-ingest` (the runtime that polls
//! or subscribes to connectors); this module is the engine-side API those
//! callers use.

use std::sync::Arc;

use cfg_connector_sdk::Resource;
use cfg_embedders::Embedder;
use cfg_vectorstore::{Chunk, VectorStore};
