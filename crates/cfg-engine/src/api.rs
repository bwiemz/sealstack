//! Public API surface that `cfg-gateway` and other external crates consume.
//!
...
///
/// Field shape mirrors `cfg_gateway::mcp::types::Caller` exactly so callers can
