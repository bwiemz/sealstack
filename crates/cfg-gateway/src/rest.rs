...
//! serialize the result. Business logic lives in `cfg-engine`; connector
//! orchestration lives in `cfg-ingest`.
//!
//! # Endpoint summary
//!
//! | Method | Path                                   | Purpose                           |
...
use cfg_engine::api::{Caller, EngineError, EngineHandle, SearchRequest};
use cfg_engine::schema_registry::SchemaMeta;
...
struct RegisterSchemaBody {
    /// Schema metadata JSON as emitted by `cfg_csl::codegen`
