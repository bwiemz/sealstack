...
//!
//! * `engine` — the concrete [`cfg_engine::Engine`]. REST handlers call through
...
use cfg_engine::Engine;
use cfg_engine::facade::EngineFacade;
use cfg_engine::store::PersistedConnector;
use cfg_ingest::{ConnectorBinding, ConnectorRegistry, IngestRuntime, SyncOutcome};
...
impl AppState {
    ...
    #[must_use]
    pub fn ingest_bindings(&self) -> Vec<cfg_ingest::registry::ConnectorBindingInfo> {
...
/// Reinstantiate every connector binding stored in `cfg_connectors`.
///
