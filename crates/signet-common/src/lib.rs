//! Shared types, errors, and identifiers used across every Signet crate.
//!
...
/// converts into `signet_engine::api::EngineError` at its surface; the gateway
/// converts into `signet_gateway::mcp::ToolError`. Each layer gets its own error
...
mod tests {
    ...
    #[test]
    fn signet_error_display() {
        let e = SignetError::Backend("boom".into());
