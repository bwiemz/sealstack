-- Extend signet_connectors with the columns needed to reconstruct a
...
CREATE INDEX IF NOT EXISTS signet_connectors_kind_idx
    ON signet_connectors (kind)
    WHERE kind <> '';
