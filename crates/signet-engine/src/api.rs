//! Public API surface that `signet-gateway` and other external crates consume.
//!
...
///
/// Field shape mirrors `signet_gateway::mcp::types::Caller` exactly so callers can
