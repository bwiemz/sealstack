...
//! the live `signet_schemas` table — for example, after a restart where schemas
...
use signet_engine::schema_registry::{RelationKind, SchemaMeta};
use serde_json::json;
