...
pub enum CslError {
    ...
    #[diagnostic(code(cfg_csl::type_check))]
    Type {
        /// Error message.
        message: String,
        /// Named source.
    ...
    #[diagnostic(
        code(cfg_csl::duplicate_primary),
    ...
    #[diagnostic(
        code(cfg_csl::unknown_ref_target),
    ...
    #[diagnostic(code(cfg_csl::duplicate_schema))]
    DuplicateSchema {
        /// Duplicated name.
        name: String,
        /// Namespace.
    ...
    #[diagnostic(code(cfg_csl::codegen))]
    Codegen {
        /// Error message.
        message: String,
    },
