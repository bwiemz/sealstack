...
pub enum CslError {
    ...
    #[diagnostic(code(signet_csl::parse))]
    Parse {
        /// Error message.
        message: String,
    ...
    #[diagnostic(code(signet_csl::type_check))]
    Type {
        /// Error message.
        message: String,
        /// Named source.
    ...
    #[diagnostic(
        code(signet_csl::missing_primary),
    ...
    #[diagnostic(
        code(signet_csl::duplicate_primary),
    ...
    #[diagnostic(
        code(signet_csl::unknown_ref_target),
    ...
    #[diagnostic(code(signet_csl::duplicate_schema))]
    DuplicateSchema {
        /// Duplicated name.
        name: String,
        /// Namespace.
    ...
    #[diagnostic(code(signet_csl::codegen))]
    Codegen {
        /// Error message.
        message: String,
    },
