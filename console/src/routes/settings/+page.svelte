...
<svelte:head>
  <title>Settings · SealStack</title>
</svelte:head>
...
<div class="px-10 py-10 max-w-3xl">
  ...
  <div class="panel p-6 space-y-5">
    ...
    <div>
      <div class="label mb-2">caller · x-sealstack-user</div>
  ...
  <div class="panel p-6 text-[13px] text-[var(--color-ink-9)] leading-relaxed space-y-2">
    ...
    <p>
      ...
      <a href="https://github.com/bwiemz/sealstack" class="link" target="_blank" rel="noreferrer">
        github.com/bwiemz/sealstack
      </a>
    </p>
    <p>
